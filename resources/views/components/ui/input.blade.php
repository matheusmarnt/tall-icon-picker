    ...
    <div class="flex flex-col gap-1">
        ...
        <div class="relative flex items-center">
            ...
            <input
                    ...
                    {{ $attributes->whereStartsWith('wire:model') }}
                    @class([
                        'w-full rounded-lg border py-2.5 text-sm transition-all duration-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500',
