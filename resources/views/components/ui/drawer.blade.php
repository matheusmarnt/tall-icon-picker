...
@else
    {{-- v1.3.0 reactive getter/setter — no $wire.entangle() initialization-order risk --}}
    <div
        x-data="{
            get open() { return $wire.{{ $property }}; },
            set open(val) { $wire.set('{{ $property }}', val); }
        }"
        x-cloak
    ...
    >
        ...
        <div
            ...
            @click="open = false"
            class="fixed inset-0 bg-gray-900/40 backdrop-blur-sm dark:bg-zinc-900/70"
        ></div>
                            ...
                            <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-zinc-800">
                                ...
                                <button
                                    ...
                                    class="rounded-lg p-1.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600
                                           ...
                                           dark:hover:bg-zinc-800 dark:hover:text-gray-300"
                                >
